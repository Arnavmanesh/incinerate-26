      ...
      <div className="footer-grid">
        <div className="footer-col">
          ...
          <div className="social-row">
            ...
            <a href="https://www.linkedin.com/company/incinerate26/" target="_blank"
        ...
        <div className="footer-col">
          ...
          <ul>
            <li>
              <a href="#why" onClick={(e) => go(e, 'why')}>About</a>
            </li>
            <li>
              <a href="#organisers" onClick={(e) => go(e, 'organisers')}>Organisers</a>
            </li>
            <li>
              <a href="#timeline" onClick={(e) => go(e, 'timeline')}>Phases</a>
            </li>
            {/* <li>
              <a href="#partners" onClick={(e) => go(e, 'partners')}>Partners</a>
            </li> */}
            <li>
              <a href="#apply" onClick={(e) => go(e, 'apply')}>Apply</a>
            </li>
          </ul>
        </div>
        ...
        {/* <div className="footer-col">
          <h4>Organisers</h4>
          <ul>
            <li><a href="#organisers" onClick={(e) => go(e, 'organisers')}>μLearn CHN</a></li>
            <li><a href="#organisers" onClick={(e) => go(e, 'organisers')}>μLearn PRN</a></li>
            <li><a href="#organisers" onClick={(e) => go(e, 'organisers')}>μLearn JUKC</a></li>
